...
<html lang="en">
  ...
  <body style="background-image: url(images/gradient.jpg); background-size: cover;">
    <div class="container">
      <div class="card mt-5 shadow" style="border-radius: 20px;">
        <div class="card-body">
          <div class="row img-login">
            <div class="col">
            <img src="images/20944530.jpg" alt="" class="float-left">
            </div>
               <div class="col">
