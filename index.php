...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
        <div class="cover-img">
            <img src="images/13261.jpg" alt="13261">
        </div>
            <h1 class="page-one">Welcome</h1>
            <h1 class="page-one-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur, aut consequuntur maiores inventore neque nostrum dolorum repellat minima atque, molestias quibusdam quod, quae sequi qui perspiciatis ea aliquid illo consequatur?
        </h1>
        <div class="login-btn">
